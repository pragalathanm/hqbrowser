...
public class QueueControlImpl implements QueueControl {
    ...
    private CoreMessagingProxy proxy;

    public QueueControlImpl(ClientSession session, SimpleString queue) throws Exception {
        proxy = new CoreMessagingProxy(session, ResourceNames.CORE_QUEUE + queue);
    }
